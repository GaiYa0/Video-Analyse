...
| C | `backend/` 业务（设备表、布控、告警）、`web/`、`docs/分工.md`、`docs/architecture.md`（总图与目录）、`docs/user-manual.md`、`.github/` | `mediaServer/conf`、`server/` 推理与模型、在 Mac 上提交「我改过官方安装脚本」之类部署改动 |
...
- 第一阶段不要主动生成 GB28181 或睡岗业务代码，除非用户明确说验收点 1 已通过。
